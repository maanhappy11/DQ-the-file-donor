...
VERIFY2_URL = environ.get('VERIFY2_URL', "sheralinks com")
VERIFY2_API = environ.get('VERIFY2_API', "8887cd1a0ffec265ece2ed8ad0abc7a0b96f0e4b")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Maan_Support_Group')
